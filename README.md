...
- Dashboard：[C4143-DVScale-Dashboard.user.js](./C4143-DVScale-Dashboard.user.js)（固定安裝網址，腳本內版本 v1.11.1）
...
- 確認網址是 `https://azurecsi.visualstudio.com/_apis/projects?api-version=6.0#crdv41qual`。
- 重新整理頁面。
